...
if(isset($_POST['sub'])){
	...
	$db=new Database();
	$db->createUser($names,sha1($password),'Accountant');
	...
	if($db->execute()){
		$Msg="<div class='alert alert-success'id='alert'>
			<strong>Success!!! Accountant Added</strong>
		</div>";
	}else{
		$Msg="<div class='alert alert-danger'id='alert'>
			<strong>Accountant Not Added</strong>
		</div>";
	}
}
...
?>
			<div class="app-content">
				...
				<div class="main-content" >
					<span style="font-size:20px"><span class="text-primary">Add a New Accountant</span></span>
					<div class="container">
					<form method="POST" action="addAccountant.php" enctype="multipart/form-data">
						<?php echo $Msg;?>
						<div class="row">
							<div class="col-sm-3">
						...
						<button class="badge badge-primary" name="sub" type="submit" style="margin-top:20px">Add Accountant</button>
					</form>
				</div>
				</div>
			</div>
