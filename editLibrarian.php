...
if(isset($_POST['sub'])){
  ...
  $db->bind(':id',$tId);
	if($db->execute()){
		echo "<script>window.open('viewLibrarian.php','_self');</script>";
	}else{
		$Msg="<div class='alert alert-danger'id='alert'>
			<strong>Librarian Details Not Updated</strong>
		</div>";
	}
}
...
?>
			<div class="app-content">
				...
				<div class="main-content" >
					<span style="font-size:20px"><span class="text-primary">Edit Librarian Details</span></span>
					<div class="container">
            <?php
            $db=new Database();
            ...
            <div style="float:right">
              <img src="<?php echo "teachers/".$results->passportName;?>" width="150px" height="150px" style="border-radius:100px">
					...
					<form method="POST" action="editLibrarian.php" enctype="multipart/form-data">
						<?php echo $Msg;?>
						<div class="row">
							<div class="col-sm-3">
