			...
			<div class="app-content">
				...
				<div class="main-content" >
						<form method="POST" action="Post.php">
							<?php echo $Msg;?>
							<fieldset>
								<legend style="border:0px;font-size:30px;"><strong>Post Exam Results</strong></legend>
								<div class="row">
									<div class="col-sm-3">
									...
									<div class="col-sm-3">
										<br>
										<button class="badge badge-success fa fa-upload" style="margin-top:10px;" name="sub">&nbsp;&nbsp;Post Exam Results</button>
									</div>
								</div>
							</fieldset>
						</form>
