  ...
  $db=new Database();
    ...
    function _endpage()
    {
      ...
      foreach ($subject as $key) {
       $this->Cell(17,5,$key->subjectAbbr,1,0,'C');
      }
      ...
      $db->query("SELECT * FROM examTotals WHERE Class=:class ORDER BY $orderParam DESC");
      ...
      foreach ($results as $data) {
        ...
        if($mark=="--"){
          ...
          $mks=$mks+1;
          if($mark<10 && $mark>0){
            $this->Cell(17,5,"0".$mark." ".$grade,1,0,'L');
          }else{
              $this->Cell(17,5,$mark." ".$grade,1,0,'L');
          }
          $count=$count+1;
        }
        }
