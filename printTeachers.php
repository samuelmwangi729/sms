    ...
    function _endpage()
    {
      ...
      foreach($detail as $key){
        ...
        $this->SetFont('Courier','B','10');
				...
				$this->Ln(10);
        $this->SetFont('Arial','B','10');
				$this->Cell(400,5,"Teachers List as at ".date("D-Y-M-d"),0,0,'C');
				$this->Ln(30);
      }
		}
		function footer(){
      ...
      $this->SetTextColor(125,125,125);
		...
		function headerTable(){
			...
			$this->Cell(80,10,'Department',1,0,'C');
		...
		function viewTable($db){
			$this->SetFont('Arial','',10);
			$results=$db->displayEmployee('teacher','Teacher');
      $total=0;
      foreach ($results as $data) {
				$this->Cell(80,10,$data->names,1,0,'C');
				$this->Cell(50,10,$data->empNumber,1,0,'C');
				$this->Cell(50,10,$data->designation,1,0,'C');
				$this->Cell(80,10,$data->department,1,0,'C');
      ...
      $this->Cell(95,10,$total." Teachers",0,0,'C');
      $this->Ln(3);
      $this->Cell(250,10," ",0,0,'C');
      $this->Cell(95,10,"===========",0,0,'C');
		}
