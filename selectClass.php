...
?>
			<div class="app-content">
				...
				<div class="main-content" >
						<form method="POST" action="printMarkSheet.php">
							<?php echo $Msg;?>
							<fieldset>
								<legend style="border:0px;font-size:30px;"><strong>Print MarkSheet</strong></legend>
								<div class="row">
									<div class="col-sm-3">
									...
									<div class="col-sm-3">
										<br>
										<button class="badge badge-success fa fa-check-circle" style="margin-top:10px;" name="sub">&nbsp;&nbsp;Select Class</button>
									</div>
								</div>
							</fieldset>
						</form>
