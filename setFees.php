...
if(isset($_SESSION['role'])){
	...
	$amount=$_POST['amount'];
		...
		if($currentTerm == $nextTerm){
			...
			$db->bind(':year',date('Y'));
			$db->execute();
			$db->query("INSERT INTO fees(votehead,term,class,amount,year) VALUES(:votehead,:term,:class,:amount,:year)");
			$db->bind(':votehead',$voteHead);
			$db->bind(':term',$term);
			$db->bind(':class',$class);
			$db->bind(':amount',$amount);
		...
		if(	$db->execute()){
			...
			$Msg="<div class='alert alert-success'id='alert'>
				<strong>Fees Successfully Added</strong>
			</div>";
		}else{
			$Msg="<div class='alert alert-danger'id='alert'>
				<strong>Fees Could Not Be Added</strong>
			</div>";
		}
		}else{
			$db=new Database();
...
if(isset($_POST['upd'])){
	$term=$_POST['term'];
	$db=new Database();
	$db->query("UPDATE currentSession SET currentSession=:currentSession WHERE id=1");
	$db->bind(':currentSession',$term);
	if($db->execute()){
		$Msg="<div class='alert alert-success'id='alert'>
			<strong>Curernt Term Updated!!</strong>
		</div>";
	}
}
?>
			<div class="app-content">
				...
				<div class="main-content" >
						...
						<div class="row">
							<div class="col-sm-6">
								<label for="term" class="label-control">SET THE CURRENT TERM</label>
							...
							<div class="col-sm-6" style="margin-top:28px">
								<button class="badge badge-primary" name="upd" type="submit">Update The Session</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="nextTerm.php" class="badge badge-success">Set Next Term Fees</a>
							</div>
						</div>
						</form>
						<br>
									...
									<table class="table table-striped table-condensed table-hover table-bordered">
										...
										<thead class="text-center">
											<tr>
												...
												echo $CurrentTerm;
													?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="Print.php?Print=1&Term=<?php echo $CurrentTerm;?>" class="fa fa-print badge badge-success text-right" style="margin-left:200px">Print Fees Structure</a></td>
											</tr>
											<tr>
										...
										<tbody>
											...
											<tr class="text-center">
												...
												<td><?php echo "<a href='setFees.php?Edit={$key->id}' class='badge badge-primary'><i class='fa fa-edit'>&nbsp;Edit</i></a>&nbsp;
												<a href='setFees.php?Delete={$key->id}' class='badge badge-danger'><i class='fa fa-times'>&nbsp;Delete</i></a>&nbsp;
												<a href='setFees.php?View={$key->id}' class='badge badge-warning'><i class='fa fa-eye'>&nbsp;View</i></a>";?></td>
											</tr>
										<?php }?>
										 </tbody>
									...
									<table class="table table-striped table-condensed table-hover table-bordered">
										...
										<thead class="text-center">
											<tr>
												...
												$database->execute();
												echo $database->fetchColumn();
													?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="Print.php?Print=2&Term=<?php echo $CurrentTerm;?>" class="fa fa-print badge badge-success text-right" style="margin-left:200px">Print Fees Structure</a></td>
											</tr>
											<tr>
												<td><?php echo "Votehead";?></td>
												<td><?php echo "Amount";?></td>
										...
										<tbody>
											...
											<tr class="text-center">
												...
												<td><?php echo "<a href='setFees.php?Edit={$key->id}' class='badge badge-primary'><i class='fa fa-edit'>&nbsp;Edit</i></a>&nbsp;
												<a href='setFees.php?Delete={$key->id}' class='badge badge-danger'><i class='fa fa-times'>&nbsp;Delete</i></a>&nbsp;
												<a href='setFees.php?Edit={$key->id}' class='badge badge-warning'><i class='fa fa-eye'>&nbsp;View</i></a>";?></td>
											</tr>
										<?php }?>
										 </tbody>
										 <tr class="text-center text-bold">
									...
									<table class="table table-striped table-condensed table-hover table-bordered">
										...
										<thead class="text-center">
											<tr>
												...
												$database->execute();
												echo $database->fetchColumn();
													?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="Print.php?Print=3&Term=<?php echo $CurrentTerm;?>" class="fa fa-print badge badge-success text-right" style="margin-left:200px">Print Fees Structure</a></td>
											</tr>
											<tr>
												<td><?php echo "Votehead";?></td>
												<td><?php echo "Amount";?></td>
									...
									<table class="table table-striped table-condensed table-hover table-bordered">
										...
										<thead class="text-center">
											<tr>
												...
												$CurrentTerm=$database->fetchColumn();
												echo $CurrentTerm;
													?> <a href="Print.php?Print=4&Term=<?php echo $CurrentTerm;?>" class="fa fa-print badge badge-success text-right" style="margin-left:200px">Print Fees Structure</a></td>
											</tr>
											<tr>
												<td><?php echo "Votehead";?></td>
												<td><?php echo "Amount";?></td>
								 ...
								 <div class="table table-responsive">
									<table class="table table-striped table-condensed table-hover table-bordered">
										...
										<tbody>
											...
											$database->execute();
											$term=$database->fetchColumn();
											$results=$database->displayFees(1,$term);
											$total=0;
											foreach ($results as $key) {
												$status="";
												$total=$total+$key->amount;
								 ...
								 <div class="table table-responsive">
									<table class="table table-striped table-condensed table-hover table-bordered">
										...
										<tbody>
											...
											$database->execute();
											$term=$database->fetchColumn();
											$results=$database->displayFees(2,$term);
											$total=0;
											foreach ($results as $key) {
													$total=$total+$key->amount;
												$status="";
								 ...
								 <div class="table table-responsive">
									<table class="table table-striped table-condensed table-hover table-bordered">
										...
										<tbody>
											...
											$database->execute();
											$term=$database->fetchColumn();
											$results=$database->displayFees(3,$term);
											$total=0;
											foreach ($results as $key) {
													$total=$total+$key->amount;
												$status="";
								 ...
								 <div class="table table-responsive">
									<table class="table table-striped table-condensed table-hover table-bordered">
										...
										<tbody>
											...
											$database->execute();
											$term=$database->fetchColumn();
											$results=$database->displayFees(4,$term);
											$total=0;
											foreach ($results as $key) {
												$status="";
													$total=$total+$key->amount;
