    					...
    					<table class="table table-striped table-codensed table-hover table-bordered">
    						...
    						<tbody>
									...
									<tr>
										...
										<td><?php
										if($status==1){
											echo "<a href='viewClasses.php?Deactivate={$key->id}' class='badge badge-danger'><i class='fa fa-times'>&nbsp;Reject</i></a>";
										}else{
											echo "<a href='viewClasses.php?Activate={$key->id}' class='badge badge-success'><i class='fa fa-check'>&nbsp;Approve</i></a>";
										}
										?></td>
										<td><?php 	echo "<a href='viewClasses.php?Edit={$key->id}' class='badge badge-primary'><i class='fa fa-edit'>&nbsp;Edit</i></a>";?></td>
										<td><?php 	echo "<a href='viewClasses.php?Delete={$key->id}' class='badge badge-danger'><i class='fa fa-times-circle'>&nbsp;Delete</i></a>";?></td>
									</tr>
								<?php }?>
    						 </tbody>
    					 </table>
