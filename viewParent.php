						...
						if(isset($_GET['Activate'])){
							...
							if($status){
								echo "<div class='alert alert-success'id='alert'>
									<strong>Parent Reinstated!!</strong>
								</div>";
							}
						}
						if(isset($_GET['Deactivate'])){
							...
							if($status){
								echo "<div class='alert alert-danger'id='alert'>
									<strong>Parent suspended!!</strong>
								</div>";
							}else{
								echo "<div class='alert alert-danger'id='alert'>
            ...
            <div class="table table-responsive">
    					<table class="table table-striped table-codensed table-hover table-bordered">
    						...
    						<tbody>
									...
									$results=$database->displayEmployee('teacher','Parent');
									...
									<tr>
										...
										<td><?php
										if($status==1){
											echo "<a href='viewParent.php?Deactivate={$key->id}' class='badge badge-danger'><i class='fa fa-times'>&nbsp;Suspend</i></a>";
										}else{
											echo "<a href='viewParent.php?Activate={$key->id}' class='badge badge-success'><i class='fa fa-check'>&nbsp;Reinstate</i></a>";
										}
										?></td>
										<td><?php 	echo "<a href='editParent.php?Edit={$key->id}' class='badge badge-primary'><i class='fa fa-edit'>&nbsp;Edit</i></a>";?></td>
										<td><?php 	echo "<a href='viewParent.php?Delete={$key->id}' class='badge badge-info'><i class='fa fa-eye'>&nbsp;View</i></a>";?></td>
									</tr>
								<?php }?>
    						 </tbody>
    					 </table>
